---
name: ui-better-colors
description: Vendored from ui-skills.com (jakubkrehel/better-colors). UI craft reference for the YGS rebuild.
source: jakubkrehel/better-colors
---
