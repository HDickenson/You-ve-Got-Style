---
name: ui-animation-vocabulary
description: Vendored from ui-skills.com (emilkowalski/animation-vocabulary). UI craft reference for the YGS rebuild.
source: emilkowalski/animation-vocabulary
---
