---
name: ui-accessible-animation
description: Vendored from ui-skills.com (iart-ai/accessible-animation). UI craft reference for the YGS rebuild.
source: iart-ai/accessible-animation
---
