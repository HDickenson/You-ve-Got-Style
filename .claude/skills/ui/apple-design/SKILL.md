---
name: ui-apple-design
description: Vendored from ui-skills.com (emilkowalski/apple-design). UI craft reference for the YGS rebuild.
source: emilkowalski/apple-design
---
